...
public class UbhRandomNearAttacker : UbhBaseShot
{
	[Header("===== RandomShotNearAttacker Settings =====")]
	...
	[FormerlySerializedAs("NearRadius")]
	public float m_nearRadius = 2;
	...
	protected virtual void Update()
	{
		...
		newpos += RotateBy(Vector2.up, angleMove, false) * Random.Range(0, m_nearRadius);
		AimTarget();
